        ...
        panels_list = [{'cacheTimeout': None,
                ...
                {'format': 'time_series', 'group': [], 'metricColumn': 'none', 'rawQuery': False,
                 ...
                 'where': [{'name': '$__timeFilter', 'params': [], 'type': 'macro'}]}], 'timeFrom': None,
                       ...
                       {'aliasColors': {}, 'bars': False, 'dashLength': 10, 'dashes': False, 'datasource': 'MySQL',
                        'fill': 1, 'fillGradient': 0, 'gridPos': {'h': 5, 'w': 17, 'x': 6, 'y': 6},
                        ...
                        'steppedLine': False, 'targets': [
                           {'format': 'time_series', 'group': [{'params': ['1s', 'none'], 'type': 'time'}],
                            ...
                            'refId': 'A', 'select': [
                               [{'params': ['gpu_Device'], 'type': 'column'}, {'params': ['avg'], 'type': 'aggregate'},
                                {'params': ['gpu_Device'], 'type': 'alias'}]], 'table': 'GPU', 'timeColumn': 'time',
                       ...
                       {'aliasColors': {}, 'bars': False, 'dashLength': 10, 'dashes': False, 'datasource': 'MySQL',
                        'fill': 1, 'fillGradient': 0, 'gridPos': {'h': 5, 'w': 17, 'x': 6, 'y': 11},
                        ...
                        'yaxis': {'align': False, 'alignLevel': None}},
                       {'aliasColors': {}, 'bars': False, 'dashLength': 10, 'dashes': False, 'datasource': 'MySQL',
                        'fill': 1, 'fillGradient': 0, 'gridPos': {'h': 5, 'w': 17, 'x': 6, 'y': 16},
                        ...
                        'yaxis': {'align': False, 'alignLevel': None}},
                       {'aliasColors': {}, 'bars': False, 'dashLength': 10, 'dashes': False, 'datasource': 'MySQL',
                        'fill': 1, 'fillGradient': 0, 'gridPos': {'h': 5, 'w': 17, 'x': 6, 'y': 21},
                        ...
                        'yaxis': {'align': False, 'alignLevel': None}},
                       {'aliasColors': {}, 'bars': False, 'dashLength': 10, 'dashes': False, 'datasource': 'MySQL',
                        'fill': 1, 'fillGradient': 0, 'gridPos': {'h': 5, 'w': 17, 'x': 6, 'y': 26},
                        ...
                        'yaxis': {'align': False, 'alignLevel': None}},
                       {'aliasColors': {}, 'bars': False, 'dashLength': 10, 'dashes': False, 'datasource': 'MySQL',
                        'fill': 1, 'fillGradient': 0, 'gridPos': {'h': 5, 'w': 17, 'x': 6, 'y': 31},
...
if __name__ == "__main__":
    ...
    panels = grafana.get_current_panels("xhHVX1O7z")
    time.sleep(1)
