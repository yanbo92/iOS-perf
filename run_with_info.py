    ...
    panels_list = [
        {'cacheTimeout': None,
               'content': '\n# INFO\n\nMarketName:       {}\n\nDeviceName:       {}\n\nProductVersion:   {}\n\n'
                          ...
                          '{}\n\nTimeZone:         {}\n\nUniqueDeviceID:   '
                          '{}\n\nWiFiAddress:      {}\n\n'
                          'BluetoothAddress: {}\n\nBasebandVersion:  {}\n\n\n\n'.format(get_device_info("MarketName"),
                                                                                        get_device_info("DeviceName"),
                                                                                        get_device_info("ProductVersion"),
                                                                                        get_device_info("ProductType"),
                                                                                        get_device_info("ModelNumber"),
                                                                                        get_device_info("SerialNumber"),
                                                                                        get_device_info("PhoneNumber"),
                                                                                        get_device_info("CPUArchitecture"),
                                                                                        get_device_info("ProductName"),
                                                                                        get_device_info("ProtocolVersion"),
                                                                                        get_device_info("RegionInfo"),
                                                                                        get_device_info("TimeIntervalSince1970"),
                                                                                        get_device_info("TimeZone"),
                                                                                        get_device_info("UniqueDeviceID"),
                                                                                        get_device_info("WiFiAddress"),
                                                                                        get_device_info("BluetoothAddress"),
                                                                                        get_device_info("BasebandVersion")),
        ...
        {'format': 'time_series', 'group': [], 'metricColumn': 'none', 'rawQuery': False,
         ...
         'where': [{'name': '$__timeFilter', 'params': [], 'type': 'macro'}]}], 'timeFrom': None, 'timeShift': None,
